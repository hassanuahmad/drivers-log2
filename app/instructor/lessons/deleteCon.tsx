    ...
    <AlertDialog open={open} onOpenChange={onCancel}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Are you sure you want to delete this lesson record? Once deleted, it
            cannot be recovered.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            ...
            onClick={async () => {
              try {
                const deleteLesson = await deleteLessonAction(recordId);
                if (deleteLesson) {
                ...
                toast.error("An error occurred while deleting lesson record", {
                  duration: 2000,
                });
              }
            }}
